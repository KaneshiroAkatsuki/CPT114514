...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::file::move_folders_to_shift_bucket,
            ...
            commands::duration_rules::save_duration_rules,
            commands::known_senders::load_known_senders,
            commands::known_senders::upsert_known_sender,
            commands::known_senders::update_known_sender,
            commands::known_senders::delete_known_sender,
            commands::measurement_people::load_measurement_people,
            commands::measurement_people::upsert_measurement_person,
            commands::measurement_people::delete_measurement_person,
            commands::personal_cleaner::preview_personal_cleaner_processes,
            commands::personal_cleaner::get_personal_cleaner_backup_info,
            commands::personal_cleaner::clean_personal_cleaner_backups,
