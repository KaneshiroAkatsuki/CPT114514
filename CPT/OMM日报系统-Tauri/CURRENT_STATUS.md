...
- Apple-inspired UI 第一阶段已设计并实施：新增设计系统文档，统一全局 tokens、基础组件、登录入口、主窗口外框、设置中心和帮助中心基础视觉。
...
powershell.exe -NoProfile -ExecutionPolicy Bypass -File scripts\package-portable.ps1 -Version 5.0.15
```
